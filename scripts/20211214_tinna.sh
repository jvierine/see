...
#freq0=4.2e6
freq1=5.43e6
# 5.432 5.40 - 5.875 3.125 kHz  25.5 30  12:00, 13:10, 13:10 key off 
#freq2=4.2e6
#freq3=4.2e6
rate=1e6
#rate3=1e6
...
#dir3=/data1/${datestr}/test${rate3}_${freq3}
...
#nohup thor.py -m 192.168.10.6 -d "A:A A:B" -c chg,chh -f $freq3 -r $rate3 ${dir3}  > log.6 2>&1 &
